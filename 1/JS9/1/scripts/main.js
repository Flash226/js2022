...
const elChangeGame = document.querySelector('select[name="changeGame"]');
const elButtons = document.querySelector('.button');
...
const startRender = () => {
    ...
    const vlChangeGame = elChangeGame.value;
    let numbersOfShip = 0;
    
    if (vlChangeGame === 'small') {
        numbersOfShip = 3;
    } else if (vlChangeGame === 'medium') {
        numbersOfShip = 7;
    } else if (vlChangeGame === 'big') {
        numbersOfShip = 10;
    }
